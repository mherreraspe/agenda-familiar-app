...
class MigracionesAgendaIT {
    ...
    void rlsOcultaOcurrenciasYRevisionDeOtraFamilia() {
        ...
        jdbc.execute("GRANT SELECT ON ocurrencias_tratamiento, elementos_revision, acciones_tratamiento, lugares_familia, palabras_clave, recurrencias_agenda, acciones_agenda, archivos_familia TO prueba_rls");
